...
from preprocess_norman import load_norman, prepare_norman
...
def main(dataset_name="kang"):
    ...
    enc_dec_hidden_size = 512               # Hidden size of encoder and decoder
    dosage_enc_hidden_size = 64             # Hidden size of dosage encoder
    discriminator_hidden_size = 32          # Hidden size of discriminators
    ...
    if dataset_name == "kang":
        ...
        norman = load_norman("../1470_script/final_project_data/Norman2019_normalized_hvg.h5ad")
        train_norman, val_norman, ood_norman = prepare_norman(norman, batch_size=batch_size, split_col="split_2")
